...
List<BbsDto> allList = dao.getBbsList();

	List<BbsDto> list = dao.getBbsListPaging(count * 10 -9, count * 10);
%>
...
<%
	...
	%>
	<a href="paging.jsp?count=<%=countM%>">[<%=countM %>]</a>
	<%
	countM ++;
	}
%>
...
<form action="bbslists.jsp" method="post">
<table>
	<tr>
		<td>
			<select name="sel">
