	...
	<h2 class="allfont" style="color: black;">회원관리</h2>
		...
		<c:forEach begin="0" end="${fn:length(listPage)-1 }" step="1" varStatus="i">
			<tr>
				...
				<td>
				<c:out value="${listPage[i.index].birthday }"></c:out>
				</td>
				<td>
				<c:out value="${listPage[i.index].phone }"></c:out>
				</td>
				<td>
				...
				<td>
				<c:out value="${listPage[i.index].total_payment }"></c:out>
				</td>
			</tr>
			...
			<tr>
			<td colspan="10">
				<c:forEach begin="1" end="<%=listPageCount %>" step="1" varStatus="i">
				
					<c:if test="${pageClickNum eq i.index }">
					...
					<c:if test="${pageClickNum ne i.index }">
