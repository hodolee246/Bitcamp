...
<form action="../common_servlet">
<input type="hidden" name="command" value="fristBook">
...
<table>
	<tr>
		<td colspan="3"><h3>일정체크/인원체크</h3></td>
	</tr>
	<tr>
		<td>체크인</td>
		<td colspan="2">
	...
	<tr>
		<td colspan="3" align="center"><h3>객실-투숙인원</h3></td>
	</tr>
	<tr>
		<td>객실</td>
		<td>
	...
	<tr>
		<td colspan="3" align="right"><button type="submit" disabled="disabled">예약하기</button></td>
	</tr>
</table>
</form>
