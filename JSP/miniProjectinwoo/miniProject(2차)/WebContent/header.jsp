		  ...
		  <div>
		    ...
		    <div class="navbar-collapse" id="navbar">
		      ...
		      <ul class="nav navbar-nav">
	              ...
	              <li><a class="allfont" href="/miniProject/notice_servlet?command=notice">공지사항</a></li>
	              <li><a class="allfont" href="/miniProject/customer_servlet?command=hotel_intro">시그니엘 소개</a></li> 
	              <li><a class="allfont" href="/miniProject/customer_servlet?command=room_intro">객실 소개</a></li>
	        	  <li><a class="allfont" href="/miniProject/customer_servlet?command=travel_intro">관광지 소개</a></li>
