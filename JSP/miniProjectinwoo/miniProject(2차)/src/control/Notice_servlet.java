...
public class Notice_servlet extends HttpServlet {	
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if( command.equals("notice_adm") ) {	//System.out.println("doPost noticeList");
			resp.sendRedirect("./Notice/notice_admin.jsp");			
		}
		...
		// 공지 리스트
		else if( command.equals("notice") ) {	//System.out.println("doPost noticeList");
			resp.sendRedirect("./Notice/noticeList.jsp");			
		}
		...
		// 공지 상세보기의 파일 다운로드
			...
			//resp.sendRedirect("/miniProject/notice_servlet?command=noticeDetail&seq="+Integer.parseInt(sseq));
