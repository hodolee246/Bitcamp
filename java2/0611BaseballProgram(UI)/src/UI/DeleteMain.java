...
public class DeleteMain extends Frame implements ActionListener, WindowListener {
	...
	public DeleteMain() {
		...
		tf = new TextField("Insert Name to Delete");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btnName.equals("Delete")) {
			...
			if(key != -1) {
				...
				JOptionPane.showMessageDialog(null, "Player Delete");
			}
			else {
				JOptionPane.showMessageDialog(null, "Can not found the Player Name");
			}
		}
