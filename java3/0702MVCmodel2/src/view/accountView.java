...
public class accountView extends JFrame implements ActionListener{
	...
	//	JOptionPane.showMessageDialog(null, "버튼 클릭");
		...
		if(btnTitle.equals("id")) {			
			...
			boolean b = dao.addMember(new Member(idTextF.getText(), passTextF.getText(), nameTextF.getText(), emailTextF.getText(), 0));
			if(b) {
		...
		*/	
		...
		if(btnTitle.equals("id")) {	
			...
			if(b) {
				JOptionPane.showMessageDialog(null, "해당 아이디는 이미 사용중입니다.");
			}else {
