...
<table>
	...
	<tr>
		...
		<td><input type="button" id="comment" onclick="location.href='answer.jsp?seq='${i.seq}'" value="답글작성"> </td>
	</tr>
		...
		<script>
			$(document).ready(function () {
				...
				$("#delete").click(function () {
					location.href="delBbs.do?seq=" + $("#_seq").val() ;
				});
				...
				$("comment").click(function () {
					location.href="commentBbs.do?seq=" + $("#_seq").val();
				});
