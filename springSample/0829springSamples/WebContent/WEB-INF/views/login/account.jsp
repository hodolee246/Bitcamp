	...
	<div id="middle_wrap">
		<div id="content_wrap">
			...
			<div style="width: 502px; height: 166px; margin-left: auto; margin-right: auto;
				...
				<div id="login_wrap">
					<form action="regi.do" method="post" id="_frmForm" name="frmForm">
						<table class="content_table" style="width: 75%">
							...
							<tr>
								<th>아이디 체크</th>
								<td>
									<input type="text" name="sid" id="_id" size="20">
									<a href="#none" id="_btnGetId" title="id체크">
										<img src="image/idcheck.png">
									</a>
									<div id="_rgetid"></div>
								</td>
							</tr>
							<tr>
								<th>아이디</th>
								<td>
									<input type="text" name="id" id="_userid" size="20" data-msg="아이디를" readonly="readonly">
								</td>
							</tr>
							<tr>
								<th>비밀번호</th>
								<td>
									<input type="text" name="pwd" id="_pwd" size="20" data-msg="비밀번호를">
								</td>
							</tr>
							<tr>
								<th>이름</th>
								<td>
									<input type="text" name="name" id="_name" size="20" data-msg="이름을">
								</td>
							</tr>
							<tr>
								<th>이메일</th>
								<td>
									<input type="text" name="email" id="_email" size="20" data-msg="이메일을">
								</td>
							</tr>
							<tr>
...
$("#_btnRegi").click(function () {
	...
	$("#frmForm").attr("action", "regi.do").submit();
...
//	alert("_btnGetId클릭");
	...
	$.ajax({
		...
		success:function(msg){
			alert(msg);
			if(msg == 'Yes'){
				$("#_rgetid").html("이 아이디는 사용할 수 없는 아이디 입니다.");
